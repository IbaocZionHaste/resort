...
public class SignUp extends AppCompatActivity {
    ...
    private void registerUser() {
        ...
        /// —––– NO MORE username existence check –––—

        /// 1) Directly create the user
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(task1 -> {
                    ...
                    if (user != null) {
                        ...
                        /// (Optional) you can still set a display name if you want,
                        /// but you'll need to decide what to use instead of 'username':
                        /// UserProfileChangeRequest profileUpdates = new UserProfileChangeRequest.Builder()
                        ///         .setDisplayName(/*someDefaultOrEmailPrefix*/)
                        ///         .build();
...
///The Username Function Exist This Code
//package com.example.resort;
//
//import android.app.AlertDialog;
//import android.app.ProgressDialog;
