...
//            @Override
//            public void onCancelled(DatabaseError error) {
//                callback.onError("Database Error: " + error.getMessage()); // More specific error message
//            }
//        });
//    }
//
//    // Add method for searching products by name
//    public void searchProductsByName(String searchTerm, final FirebaseCallback callback) {
//        Query query = databaseReference.orderByChild("name").startAt(searchTerm).endAt(searchTerm + "\uf8ff");
//
//        query.addValueEventListener(new ValueEventListener() {
//            @Override
//            public void onDataChange(DataSnapshot snapshot) {
...
//                    }
//                }
//                callback.onCallback(products); // Return the filtered list based on the name search
//            }
//
//            @Override
//            public void onCancelled(DatabaseError error) {
//                callback.onError("Database Error: " + error.getMessage()); // Handle cancellation or error
//            }
//        });
//    }
//}
